...
BASEDIR=/lustre/work/kevsulli/work/Sequences/MitoBim
...
RAW_READS_HOME=/lustre/work/kevsulli/work/Sequences/MitoBim/Pear   #the location of your raw data
...
for RAW_READ_FILE in $RAW_READS_HOME/*.fastq.unassembled.reverse.fastq
do
	SAMPLE_ID=$(basename $RAW_READ_FILE .fastq.unassembled.reverse.fastq)
